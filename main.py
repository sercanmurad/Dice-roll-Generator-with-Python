...
def num_dice():
  #We create function that give user option to chose one or two dice
  while True:
      try:
          ...
          if num_dice not in valid_responses:
              ...
              return num_dice
          #If user chose wrong number we print error to screen
      except ValueError as err:
          print(err)


def roll_dice():
    #Dice elements function
   min_val = 1
   max_val = 6
   roll_again = 'y'
#We create os function to improve user experiance
...
if __name__ == '__main__':
    #We call the main function roll_dice
   roll_dice()